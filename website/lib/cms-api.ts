...
if (process.env.DATOCMS_READ_ONLY_API_TOKEN) {
  ...
  cmsApi = {
    getAllSpeakers: () => Promise.resolve([
      ...
      //   name: 'Lee Robinson',
      //   twitter: 'leeerob',
      //   title: 'Head of DevRel at Vercel',
      //   bio: `Lee is the Head of Developer Relations for Next.js and Vercel, helping developers build a faster web. He teaches about web development, serverless and edge, and modern web architecture.`,
